...
type DriverHistoryListProps = { missions: Mission[]; loading: boolean };

export default function DriverHistoryList({ missions, loading }: DriverHistoryListProps) {
